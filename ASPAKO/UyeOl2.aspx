<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UyeOl2.aspx.cs" Inherits="ASPAKO.UyeOl2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div >
            <div class="container" style="width:520px; height:520px">
                <table>
                    <tr>
                        <td class="auto-style1">Üye Kayıt Sayfası</td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
